...
namespace Sun.Identity.Saml2
{
    ...
    public static class AuthnRequestCache
    {
        ...
        internal static Queue GetSentAuthnRequests(HttpContext context)
        {
            ...
            //if (context.Session[AuthnRequestCache.AuthnRequestSessionAttribute] == null)
            //    throw new Exception(AuthnRequestCache.AuthnRequestSessionAttribute + " AuthnRequestSessionAttribute is null");
